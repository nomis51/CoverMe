package com.jetbrains.rider.plugins.coverme.ui.lineMarkers
...
class CoverageLineMarker : LineMarkerProvider {
    override fun getLineMarkerInfo(element: PsiElement): LineMarkerInfo<*>? {
        ...
        val coverageService = project.service<CoverageService>()
        ...
        val isCovered = coverageService.isLineCovered(
            absoluteFilePath,
            lineNumber + 1
        )
        if (isCovered == null) return null
    ...
    private fun isFirstTokenInLine(
        element: PsiElement,
        document: Document,
        lineNumber: Int
    ): Boolean {
    ...
    class VerticalLineIcon(covered: Boolean) : Icon {
        ...
        override fun paintIcon(
            ...
            dashedLine(
                ...
                x,
                y,
                if (_covered) JBColor.GREEN else JBColor.RED
            )
        }
